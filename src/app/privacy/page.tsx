      ...
      <Container className="py-16 sm:py-24">
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-8 text-base leading-relaxed text-ink-muted">
            ...
            <section><h2 className="font-serif text-2xl text-ink">Cookies and advertising technology</h2><p className="mt-3">PalmTec does not currently use its own advertising pixels or analytics cookies on this website. Our providers may use essential technical cookies or similar technologies needed to run and secure their services. If we add analytics, remarketing, or other advertising technology, we will update this notice and provide any required choices or notices.</p></section>
